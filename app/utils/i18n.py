...
TRANSLATIONS: Dict[str, Dict[str, Any]] = {
    "en": {
        "template": {
            ...
            "empty_state": "No files added yet. Add PDF or JPG files above to configure their ranges.",
        ...
        "client": {
            ...
            "messages": {
                "empty": "No files added yet. Add PDF or JPG files above to configure their ranges.",
    ...
    "ko": {
        "template": {
            ...
            "drop_instruction": "PDF 또는 JPG 파일을 DRAG & DROP 또는 클릭하여 업로드하세요.",
            "drop_detail": "파일은 병합을 선택할 때까지 이 기기에만 머무릅니다.",
            "upload_limit_note": "총 {limit}MB까지 업로드할 수 있습니다.",
            "empty_state": "아직 추가된 파일이 없습니다. 위에서 PDF 또는 JPG를 추가하세요.",
        ...
        "client": {
            ...
            "messages": {
                "empty": "아직 추가된 파일이 없습니다. 위에서 PDF 또는 JPG를 추가하세요.",
